...
function getSong(act){
  ...
  // Se la canzone
if (act == 0) { message = `<i style="color: #ff7070;">Wrong! The song was <b style="color: #ff7070;>"${songTitle}".</b></i>`; } 
else if (act == 1) { message = `<i>The song you just skipped was <b>"${songTitle}".</b></i>`; } 
else if (act == 2) { playE(); message = `<i style="color: #70ff77;">Correct! The song was <b style="color: #70ff77;>"${songTitle}".</b></i>`; cnt++; }
